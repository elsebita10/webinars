	...
	<body>
	    <div class="generic-container">
	        ...
	        <form:form method="POST" modelAttribute="user" class="form-horizontal">
	            ...
	            <div class="row">
	                <div class="form-group col-md-12">
	                    <label class="col-md-3 control-lable" for="code">ID de usuario</label>
	                    <div class="col-md-7">
	                        <c:choose>
	                            <c:when test="${edit}">
	                                <form:input type="text" path="code" id="code" class="form-control input-sm" disabled="true"/>
	                            </c:when>
	                            <c:otherwise>
	            ...
	            <div class="row">
	                <div class="form-group col-md-12">
	                    <label class="col-md-3 control-lable" for="phone">Teléfono</label>
	                    <div class="col-md-7">
